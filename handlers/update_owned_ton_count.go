...
func (h *UpdateOwnedTonCount) CheckUpdate(b *gotdbot.Client, ctx *gotdbot.Context) bool {
...
func (h *UpdateOwnedTonCount) HandleUpdate(b *gotdbot.Client, ctx *gotdbot.Context) error {
